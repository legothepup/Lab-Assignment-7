...
int main() {
    ...
    // Reset swaps arrays
    int resetSwaps[100] = {0};

    // Perform Selection Sort on array1
    selectionSort(array1, n1, resetSwaps);
    printResults(array1, n1, resetSwaps, "Selection Sort");

    // Perform Selection Sort on array2
    selectionSort(array2, n2, resetSwaps);
    printResults(array2, n2, resetSwaps, "Selection Sort");
